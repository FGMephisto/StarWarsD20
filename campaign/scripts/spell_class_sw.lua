...
function onStatUpdate() -- Adjusted
...
function toggleDetail() -- Adjusted
...
function onCasterTypeChanged() -- Adjusted
...
function onDisplayChanged() -- Adjusted
	if minisheet then
		return;
	end
...
function updateSpellView() -- Adjusted
	local nodeSpellClass = getDatabaseNode();
...
function performFilter() -- Adjusted
	-- for _,vLevel in pairs(levels.getWindows()) do
...
function showSpellsForLevel(nLevel) -- Adjusted
	do return; end -- Disabled -> exit
